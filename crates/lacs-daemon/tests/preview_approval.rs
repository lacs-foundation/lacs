...
use lacs_daemon::policy::{approval_matches_request, require_fresh_approval, ApprovalError};
use lacs_daemon::preview::preview_action;
use lacs_daemon::transactions::{NewTransaction, TransactionStore};
use lacs_types::{JobState, PreviewEnvelope, RequestEnvelope, RiskLevel};
use serde_json::json;
...
fn request(action_name: &str, request_id: &str, request_hash: &str) -> RequestEnvelope {
    RequestEnvelope {
        ...
        params: json!({}),
        caller_role: lacs_types::CallerRole::Admin,
